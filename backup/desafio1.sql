...
CREATE TABLE SpotifyClone.planos(
  ...
  CONSTRAINT FK_PLANO FOREIGN KEY (plano_id) REFERENCES planos (plano_id)
  ) engine = InnoDB;
  
  INSERT INTO SpotifyClone.usuarios(usuario, usuario_idade, data_assinatura, plano_id)
  VALUES
...
CREATE TABLE SpotifyClone.artistas(
  ...
  VALUES
	...
	CREATE TABLE SpotifyClone.cancoes(
     ...
     INSERT INTO SpotifyClone.cancoes(cancao, duracao_segs, album_id)
  VALUES
    ('BREAK MY SOUL', 279, 1),
  ...
  VALUES
    ...
    CREATE TABLE SpotifyClone.historico_de_reproducoes(
      cancao_id INT,
      usuario_id INT,
      data_reproducao TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
